...
constants.colors.tilegrid_div[1] = {r=0.3,g=0.3,b=0.7,a=0.4}
constants.colors.tilegrid_div[5] = {r=0.3,g=0.8,b=0.3,a=0.4}
constants.colors.tilegrid_div[25] = {r=0.9,g=0.3,b=0.3,a=0.4}
constants.colors.tilegrid_div[100] = {r=0.8,g=0.8,b=0.3,a=0.4}
constants.colors.tilegrid_border = {r=0.7,g=0.7,b=0.7,a=0.4}
