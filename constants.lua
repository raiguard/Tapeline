...
constants.colors.tilegrid_div[2] = {r=0.3,g=0.8,b=0.3,a=0.7}
constants.colors.tilegrid_div[3] = {r=0.9,g=0.3,b=0.3,a=0.7}
constants.colors.tilegrid_div[4] = {r=0.8,g=0.8,b=0.3,a=0.7}
