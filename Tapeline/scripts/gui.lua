...
function on_setting_changed(e) change_setting(e) end
...
function create_dialog_menu(player, center_gui)
    local dialog_frame = center_gui.add{type='frame', name='tapeline_dialog_frame', style='dialog_frame', direction='vertical', caption={'gui.confirmation'}}
    dialog_frame.add{type='label', name='delete_dialog_info', style='dialog_info', caption={'gui-caption.delete-dialog-info', global.player_data[player.index].cur_tilegrid_index}}

    local buttons_flow = dialog_frame.add{type='flow', name='dialog_buttons_flow', style='dialog_buttons_horizontal_flow', direction='horizontal'}
    buttons_flow.add{type='button', name='dialog_back_button', style='back_button', caption={'gui.cancel'}}
    buttons_flow.add{type='frame', name='dialog_spacer', style='draggable_space_filler', direction='horizontal'}
    buttons_flow.add{type='button', name='dialog_confirm_button', style='red_confirm_button', caption={'gui.delete'}}
end
